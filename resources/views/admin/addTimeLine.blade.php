                                ...
                                <div id="wizard" class="form_wizard wizard_horizontal">
                                    ...
                                    <div>
                                        <div id="step-1" class="tab-pane" role="tabpanel">
                                            <form class="form-info-tour" action="{{ route('admin-add-timeline-tour') }}"
                                                ...
                                                <div class="form-sets-container">
                                                    <div id="form-sets">
                                                        ...
                                                        <div class="form-set" id="form-set-1">
                                                            <h2 style="text-align: center;">Ngày 1</h2>
                                                            <div class="field item form-group">
                                                                <label
                                                                    class="col-form-label col-md-3 col-sm-3 label-align">Điểm đến
                                                                    <span>*</span></label>
                                                                <div class="col-md-6 col-sm-6">
                                                                    <input class="form-control" name="name_1"
                                                                        placeholder="Nhập tên Tour" required>
                                                                </div>
                                                            </div>
                                                            <div class="field item form-group bad">
                                                                <label
                                                                    class="col-form-label col-md-3 col-sm-3 label-align">Mô tả 
                                                                    <span>*</span></label>
                                                                <div class="col-md-6 col-sm-6">
                                                                    <textarea name="description_1" rows="6" style="width: 100%;" required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
