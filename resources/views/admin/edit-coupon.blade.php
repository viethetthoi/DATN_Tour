                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content add-tours">
                                    <!-- Smart Wizard -->
                                    <p>Cập nhật thông tin chi tiết để tạo một phiếu khuyến mãi mới!!</p>
                                    <div id="wizard" class="form_wizard wizard_horizontal">

                                        <div id="step-1">
                                            <form class="form-info-tour"
                                                action="{{ route('admin-edit-submit-coupon', ['couponId' => $coupon->couponId]) }}"
                                                ...
                                                <div class="field item form-group bad">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <textarea name="description" id="description" rows="6" style="width: 100%;" required> {{ $coupon->title }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="text" class="form-control" name="code"
                                                            ...
                                                            value="{{ $coupon->codeCoupon }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="number" class="form-control" name="discount"
                                                            id="discount" placeholder="Nhập Ưu đãi" required
                                                ...
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="date" class="form-control" name="start_date"
                                                            required value="{{ $coupon->startDate }}">
                                                    </div>
                                                </div>
                                                <div class="field item form-group">
